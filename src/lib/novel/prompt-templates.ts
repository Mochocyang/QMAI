...
export const PROMPTS = {
  ...
  outlineGeneration: (genre: string, scale: string, premise: string, context = "") =>
    [
      ...
      context ? "以上资料属于硬性约束，尤其是剧情框架强约束，不得在生成内容中忽略、弱化或改写。" : "",
      "",
      ...
      "3. 如果是章节细纲，必须按五段输出：### 本章钩子 / ### 铺垫 / ### 爽点 / ### 结尾钩子 / ### 作者手搓留白。",
      "4. 作者手搓留白只标注需要作者用人设卡、文风、对话设计、整活或玩梗补充的位置，AI 不要代写血肉层。",
      "5. 主要人物设定（姓名、性格、动机、人物弧线、关键关系）",
      "6. 世界观设定（核心设定规则、势力分布、能力体系、重要地点）",
      "7. 伏笔计划（主要伏笔的埋设、推进、回收节点）",
    ].join("\n"),
  ...
  outlineRefinementGeneration: (outlineContext: string, sectionHints: string, userRequest: string) =>
    [
      ...
      '   - "foreshadowingPlan"',
      '   - "locationsOutline"',
      "3. chapterOutlines 必须按「钩子-铺垫-爽点-结尾钩子」四段结构组织，每章写清对应的五段细纲（钩子/铺垫/爽点/结尾钩子/作者手搓留白），最后一段为必填。",
